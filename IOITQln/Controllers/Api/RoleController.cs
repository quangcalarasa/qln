                    ...
                    try
                    {
                        ...
                        if(input.functionRoles != null)
                        {
                            foreach (FunctionRole functionRole in input.functionRoles)
                            {
                                ...
                                {
                                    functionRoleExist.ActiveKey = functionRole.ActiveKey;
                                    functionRoleExist.UpdatedAt = DateTime.Now;
                                    functionRoleExist.UpdatedById = userId;
                                    functionRoleExist.UpdatedBy = fullName;
                                    _context.Update(functionRoleExist);

                                    functionRoles.Remove(functionRoleExist);
                                }
                            }
                        }
