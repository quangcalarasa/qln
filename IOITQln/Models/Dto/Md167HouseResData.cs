...
// IOITQln.Models.Dto.Md167HouseResData
using System;
...
public class Md167HouseResData
{
    public int Id
    {
        get;
    ...
    public double? UnitPriceValueTotal
    {
        get;
        set;
    }
    ...
    public string ApaKiosCode
    {
        get;
        set;
    }

    public string? OldNameHouse
    {
    ...
    public string TotalAreaValue
    {
        get;
        set;
    }

    public string TotalFloorValue
    {
        get;
        set;
    }

    public string TotalTaxNN
    {
        get;
        set;
    }
    ...
    public List<Md167KiosResData> md167Kios
    {
        get;
        set;
    }
