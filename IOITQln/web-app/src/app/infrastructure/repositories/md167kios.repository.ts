...
export class Md167KiosRepository {
    ...
    public DeleteKios(params: any) {
        return this.baseHttpClient.getRequest({
            url: `${this.baseUrl}/DeleteKios/${params}`,
        });
    }
    ...
    public async ImportDataExcelKios(param: any) {
        return this.baseHttpClient.uploadRequest({
          url: `${this.baseUrl}/ImportDataExcelKios`,
          body: param
        });
    }
}
