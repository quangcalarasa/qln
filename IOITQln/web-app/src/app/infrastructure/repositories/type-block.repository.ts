...
export class TypeBlockRepository {
    public baseUrl = "/api/TypeBlock";
    ...
    public getByTypeReportApply(typeReportApply: number) {
        return this.baseHttpClient.getRequest({
            url: `${this.baseUrl}/getByTypeReportApply/${typeReportApply}`,
        });
    }
}
