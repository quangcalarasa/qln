...
export class LandscapeLimitRepository {
    public baseUrl = "/api/LandscapeLimit";
    ...
    public getItemByDecreeTypeReportApplyDistrict(decreeId: number, termapply: number, district: number) {
        return this.baseHttpClient.getRequest({
            url: `${this.baseUrl}/getItemByDecreeTypeReportApplyDistrict/${decreeId}/${termapply}/${district}`
        });
    }
}
