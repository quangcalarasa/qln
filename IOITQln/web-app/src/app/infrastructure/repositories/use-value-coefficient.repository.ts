...
export class UseValueCoefficientRepository {
    public baseUrl = "/api/UseValueCoefficient";
    ...
    public getUseValueCoefficientItems(typeReportApply: number) {
        return this.baseHttpClient.getRequest({
            url: `${this.baseUrl}/getUseValueCoefficientItems/${typeReportApply}`,
        });
    }
}
