...
export class DistributionFloorCoefficientRepository {
    public baseUrl = "/api/DistributionFloorCoefficient";
    ...
    public getFlatCoefficientData() {
        return this.baseHttpClient.getRequest({
            url: `${this.baseUrl}/getFlatCoefficientData`,
        });
    }
}
