...
export class ReportPlatformRepository {
  public baseUrl = '/api/TdcPlatformManager';
  ...
  public ExportExcel(params: any) {
    return this.baseHttpClient.exportReport("BaoCaoNenDat", {
      url: `${this.baseUrl}/ExportExcel`,
      body: params
    });
  }

  public ExcelRP2(TypeLegalId: number) {
    return this.baseHttpClient.downloadFile({
      url: `${this.baseUrl}/ExcelRP2?TypeLegalId=${(TypeLegalId)}`,
