...
export class NocApartmentFileRepository {
  public baseUrl = '/api/NocApartmentFile';
  ...
  public getPay(nocApartmentFile: number) {
    return this.baseHttpClient.getRequest({
      url: `${this.baseUrl}/getFile/${nocApartmentFile}`
    });
  }
}
