...
export class InvestmentRateRepository {
    public baseUrl = "/api/InvestmentRate";
    ...
    public getInvestmentRateItems(typeReportApply: number) {
        return this.baseHttpClient.getRequest({
            url: `${this.baseUrl}/getInvestmentRateItems/${typeReportApply}`,
        });
    }
}
