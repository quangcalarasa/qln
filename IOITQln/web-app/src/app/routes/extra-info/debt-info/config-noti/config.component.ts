...
import { ExtraConfigNotiRepository } from 'src/app/infrastructure/repositories/extra-config-noti.repository';
...
@Component({
  ...
  export class ExtraConfigNotiComponent implements OnInit {
    ...
    constructor(private fb: FormBuilder,
        ...
        private extraConfigNotiRepository: ExtraConfigNotiRepository ,
    ...
    async getData() {
        const resp = await this.extraConfigNotiRepository.getPort();
    ...
    submitForm() {
        ...
        const resp = this.extraConfigNotiRepository.updatePort(data)
        this.loading = false;
        this.modalSrv.info({
