...
export class AddOrUpdateManPurposeComponent implements OnInit {
  ...
  constructor(private drawerRef: NzDrawerRef<string>, private fb: FormBuilder,
    private m167ManPurposeRepository: Md167ManPurposeRepository, private cdr: ChangeDetectorRef) { }
  ...
  async submitForm() {
    ...
    const resp = data.Id ? await this.m167ManPurposeRepository.update(data) : await this.m167ManPurposeRepository.addNew(data);
