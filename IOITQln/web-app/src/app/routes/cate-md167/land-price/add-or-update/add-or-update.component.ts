...
export class AddOrUpdateMd167LandPriceComponent implements OnInit {
  ...
  constructor(private drawerRef: NzDrawerRef<string>, private fb: FormBuilder, private landPriceRepository: Md167LandPriceRepository, private cdr: ChangeDetectorRef, private unitPriceRepository: UnitPriceRepository, private laneRepository: LaneRepository, private provinceRepository: ProvinceRepository, private message: NzMessageService) { }
