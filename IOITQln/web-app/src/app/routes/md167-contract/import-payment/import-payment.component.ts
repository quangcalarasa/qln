...
// @Component({
//   selector: 'app-md167-contract-import-payment',
//   templateUrl: './import-payment.component.html',
//   styles: []
// })
// export class Md167ContractImportPaymentComponent implements OnInit {
//   data: any[] = [];
//   loading = false;
...
//   constructor(private md167ReceiptRepository: Md167ReceiptRepository, private drawerRef: NzDrawerRef<string>, private uploadRepository: UploadRepository, private importHistoryRepository: ImportHistoryRepository) { }
...
//     const resp = await this.importHistoryRepository.getByPage(this.paging, ImportHistoryTypeEnum.Md167Receipt);
...
//   downloadTemplate() {
//     this.uploadRepository.downloadFileExcelTemplate(ImportHistoryTypeEnum.Md167Receipt);
//   }
