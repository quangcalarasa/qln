...
@Component({
    selector: 'app-cate-apartment-info',
...
export class ApartmentInfoComponent implements OnInit {
    ...
    calcConstructionAreaValue() {
        ...
        if (!constructionAreaValue1 && !constructionAreaValue2 && !constructionAreaValue3) {
            ...
            this.validateForm.get('ConstructionAreaValue')?.setValue(constructionAreaValue);
        }
    }
    ...
    calcUseAreaValue() {
        ...
        if (!useAreaValue1 && !useAreaValue2) {
            ...
            this.validateForm.get('UseAreaValue')?.setValue(useAreaValue);
        }
    }
}
