...
@Component({
  selector: 'app-report-noc-usage-status',
  templateUrl: './usage-status.component.html',
  styles: []
})
export class UsageStatusReportComponent implements OnInit {
  ...
  public statusBar: {
    ...
    public columnDefs: (ColDef | ColGroupDef)[] = [
      ...
      { headerName: 'Tình trạng căn nhà', field: 'UsageStatus', onCellClicked: (evt) => { this.viewRow(evt) } }
    ];
  ...
  async getDataReport() {
    ...
    const resp = await this.reportNocRepository.GetStatusBlockNocReport(this.validateForm.value);
