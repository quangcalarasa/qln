...
@Component({
  selector: 'app-report-noc-overdue-contract',
  templateUrl: './overdue-contract.component.html',
  styles: []
})
export class OverdueContractReportComponent implements OnInit {
  ...
  public statusBar: {
    ...
    public columnDefs: (ColDef | ColGroupDef)[] = [
      ...
      { headerName: 'Ngày thanh toán gần nhất', field: 'NearDatePay', onCellClicked: (evt) => { this.viewRow(evt) } },
      ...
      { headerName: 'Thời gian quá hạn', field: 'DateDiff', onCellClicked: (evt) => { this.viewRow(evt) } },
      {
  ...
  async getDataReport() {
    ...
    const resp = await this.reportNocRepository.GetDataExport2(this.validateForm.value);
